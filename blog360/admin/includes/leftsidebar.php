  ...
  <li class="has_sub">
                                <a href="manage-blog.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Manage Blog </span> </a>
                            </li>
   ...
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> blog360@gmail.com</p>
                    </div>
